    ...
    return (
        <header className="z-[99999] relative">
            ...
            <motion.div
                ...
                className="fixed top-0 -translate-x-1/2 w-full h-16 bg-black/20 border border-neutral-800/50 rounded-none shadow-lg left-1/2 bg-opacity-80 shadow-black/50 backdrop-blur-md sm:top-6 sm:h-12 sm:w-[23rem] sm:rounded-full mx-auto overflow-hidden hidden lg:inline-block"
            >
                <motion.div
